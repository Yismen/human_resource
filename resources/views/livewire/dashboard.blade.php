            ...
            <div class="card">
                <div class="card-body">
                    <livewire:human_resource::charts.column title="Monthly Headcount" :keys="$attrition->keys()->all()"
                        ...
                        height="20rem;" :with-random-colors="true" key="{{ now() }}" />
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <livewire:human_resource::charts.line title="Monthly Attrition Rate"
                        ...
                        :with-random-colors="true" height="20rem;" key="{{ now() }}" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Site"
                                ...
                                :values="$by_site->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Project"
                                ...
                                :values="$by_project->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Department"
                                ...
                                :values="$by_department->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Position"
                                ...
                                :values="$by_position->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Supervisor"
                                ...
                                :values="$by_supervisor->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Gender"
                                ...
                                :values="$by_gender->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Marriage"
                                ...
                                :values="$by_marriage->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <livewire:human_resource::charts.pie title="Employees by Parenting"
                                ...
                                :values="$by_kids->pluck('employees_count')->all()" key="{{ now() }}" />
                        </div>
                    </div>
                </div>
            </div>
