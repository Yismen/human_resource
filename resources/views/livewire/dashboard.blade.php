<div>
    <div class="row">
        <div class="col-6 col-lg-4 col-xl-3 ">
            <x-human_resource::infographic type="info" count="{{ $forms_count }}">
                Total Forms
            </x-human_resource::infographic>
        </div>

        <div class="col-6 col-lg-4 col-xl-3">
            <x-human_resource::infographic type="info" count="{{ $questions_count }}" icon="fas fa-question-circle">
                Total Questions
            </x-human_resource::infographic>
        </div>

        <div class="col-6 col-lg-4 col-xl-3">
            <x-human_resource::infographic type="info" count="{{ $entries_count }}" icon="fas fa-ranking-star">
                Total Entries
            </x-human_resource::infographic>
        </div>
    </div>
