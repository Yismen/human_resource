...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ mix('css/app.css', 'vendor/dainsys/human_resource') }}">
    @livewireStyles
    <style>
        [x-cloak] {
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link text-center text-uppercase">
                ...
                <span class="brand-text font-weight-light">{{ config('app.name', 'Dainsys HumanResource') }}</span>
            </a>

            @include('human_resource::layouts.navigation')
        </aside>
